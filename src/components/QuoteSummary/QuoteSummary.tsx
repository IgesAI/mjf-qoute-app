...
import { Material, ModelMetrics, PriceBreakdown } from '../../utils/priceCalculator';
import { OPERATING_COSTS } from '../../utils/priceConstants';
...
const QuoteSummary: React.FC<QuoteSummaryProps> = ({ metrics, quoteData, material }) => {
  if (!quoteData || !material) return null;
